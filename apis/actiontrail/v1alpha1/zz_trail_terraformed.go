...
func (mg *Trail) GetTerraformResourceType() string {
	return "alicloud_actiontrail_trail"
}
...
func (tr *Trail) GetObservation() (map[string]interface{}, error) {
...
func (tr *Trail) SetObservation(obs map[string]interface{}) error {
...
func (tr *Trail) GetParameters() (map[string]interface{}, error) {
...
func (tr *Trail) SetParameters(params map[string]interface{}) error {
