...
func (tr *Binding) GetObservation() (map[string]interface{}, error) {
...
func (tr *Binding) SetObservation(obs map[string]interface{}) error {
...
func (tr *Binding) GetParameters() (map[string]interface{}, error) {
...
func (tr *Binding) SetParameters(params map[string]interface{}) error {
