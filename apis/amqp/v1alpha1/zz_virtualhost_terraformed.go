...
func (mg *VirtualHost) GetTerraformResourceType() string {
	return "alicloud_amqp_virtual_host"
}
...
func (tr *VirtualHost) GetObservation() (map[string]interface{}, error) {
...
func (tr *VirtualHost) SetObservation(obs map[string]interface{}) error {
...
func (tr *VirtualHost) GetParameters() (map[string]interface{}, error) {
...
func (tr *VirtualHost) SetParameters(params map[string]interface{}) error {
