...
func (mg *UserAttachment) GetTerraformResourceType() string {
	return "alicloud_bastionhost_user_attachment"
}
...
func (tr *UserAttachment) GetObservation() (map[string]interface{}, error) {
...
func (tr *UserAttachment) SetObservation(obs map[string]interface{}) error {
...
func (tr *UserAttachment) GetParameters() (map[string]interface{}, error) {
...
func (tr *UserAttachment) SetParameters(params map[string]interface{}) error {
...
// LateInitialize this UserAttachment using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *UserAttachment) LateInitialize(attrs []byte) (bool, error) {
	params := &UserAttachmentParameters{}
