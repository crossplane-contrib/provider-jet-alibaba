...
func (mg *DataCenter) GetTerraformResourceType() string {
	return "alicloud_cassandra_data_center"
}
...
func (tr *DataCenter) GetObservation() (map[string]interface{}, error) {
...
func (tr *DataCenter) SetObservation(obs map[string]interface{}) error {
...
func (tr *DataCenter) GetParameters() (map[string]interface{}, error) {
...
func (tr *DataCenter) SetParameters(params map[string]interface{}) error {
...
// LateInitialize this DataCenter using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *DataCenter) LateInitialize(attrs []byte) (bool, error) {
	params := &DataCenterParameters{}
