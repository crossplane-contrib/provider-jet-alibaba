...
type BandwidthPackageParameters struct {
	...
	CenBandwidthPackageName *string `json:"cenBandwidthPackageName,omitempty" tf:"cen_bandwidth_package_name,omitempty"`
	...
	// +kubebuilder:validation:Optional
	GeographicRegionAID *string `json:"geographicRegionAId,omitempty" tf:"geographic_region_a_id,omitempty"`

	// +kubebuilder:validation:Optional
	GeographicRegionBID *string `json:"geographicRegionBId,omitempty" tf:"geographic_region_b_id,omitempty"`

	// +kubebuilder:validation:Optional
	GeographicRegionIds []*string `json:"geographicRegionIds,omitempty" tf:"geographic_region_ids,omitempty"`
