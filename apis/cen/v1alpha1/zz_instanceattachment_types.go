...
type InstanceAttachmentParameters struct {
	...
	CenOwnerID *float64 `json:"cenOwnerId,omitempty" tf:"cen_owner_id,omitempty"`

	// +kubebuilder:validation:Required
	ChildInstanceID *string `json:"childInstanceId" tf:"child_instance_id,omitempty"`

	// +kubebuilder:validation:Optional
	ChildInstanceOwnerID *float64 `json:"childInstanceOwnerId,omitempty" tf:"child_instance_owner_id,omitempty"`

	// +kubebuilder:validation:Required
	ChildInstanceRegionID *string `json:"childInstanceRegionId" tf:"child_instance_region_id,omitempty"`

	// +kubebuilder:validation:Required
	ChildInstanceType *string `json:"childInstanceType" tf:"child_instance_type,omitempty"`
