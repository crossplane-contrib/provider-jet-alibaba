...
func (tr *RouteMap) GetObservation() (map[string]interface{}, error) {
...
func (tr *RouteMap) SetObservation(obs map[string]interface{}) error {
...
func (tr *RouteMap) GetParameters() (map[string]interface{}, error) {
...
func (tr *RouteMap) SetParameters(params map[string]interface{}) error {
