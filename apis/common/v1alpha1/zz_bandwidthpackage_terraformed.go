...
func (mg *BandwidthPackage) GetTerraformResourceType() string {
	return "alicloud_common_bandwidth_package"
}
...
func (tr *BandwidthPackage) GetObservation() (map[string]interface{}, error) {
...
func (tr *BandwidthPackage) SetObservation(obs map[string]interface{}) error {
...
func (tr *BandwidthPackage) GetParameters() (map[string]interface{}, error) {
...
func (tr *BandwidthPackage) SetParameters(params map[string]interface{}) error {
...
// LateInitialize this BandwidthPackage using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *BandwidthPackage) LateInitialize(attrs []byte) (bool, error) {
	params := &BandwidthPackageParameters{}
