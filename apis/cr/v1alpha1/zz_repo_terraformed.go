...
func (tr *Repo) GetObservation() (map[string]interface{}, error) {
...
func (tr *Repo) SetObservation(obs map[string]interface{}) error {
...
// GetID returns ID of underlying Terraform resource of this Repo
...
func (tr *Repo) GetParameters() (map[string]interface{}, error) {
...
func (tr *Repo) SetParameters(params map[string]interface{}) error {
...
// LateInitialize this Repo using its observed tfState.
