...
func (tr *Kubernetes) GetObservation() (map[string]interface{}, error) {
...
func (tr *Kubernetes) SetObservation(obs map[string]interface{}) error {
...
func (tr *Kubernetes) GetParameters() (map[string]interface{}, error) {
...
func (tr *Kubernetes) SetParameters(params map[string]interface{}) error {
