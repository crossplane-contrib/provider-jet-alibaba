...
type TopicParameters struct {
	...
	// +kubebuilder:validation:Optional
	LifeCycle *float64 `json:"lifeCycle,omitempty" tf:"life_cycle,omitempty"`

	// +kubebuilder:validation:Required
	ProjectName *string `json:"projectName" tf:"project_name,omitempty"`

	// +kubebuilder:validation:Optional
	RecordSchema map[string]*string `json:"recordSchema,omitempty" tf:"record_schema,omitempty"`
