...
type MigrationInstanceObservation struct {
...
type MigrationInstanceParameters struct {
...
// MigrationInstanceSpec defines the desired state of MigrationInstance
type MigrationInstanceSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     MigrationInstanceParameters `json:"forProvider"`
}

// MigrationInstanceStatus defines the observed state of MigrationInstance.
type MigrationInstanceStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        MigrationInstanceObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// MigrationInstance is the Schema for the MigrationInstances API
...
type MigrationInstance struct {
	...
	Spec              MigrationInstanceSpec   `json:"spec"`
	Status            MigrationInstanceStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// MigrationInstanceList contains a list of MigrationInstances
type MigrationInstanceList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []MigrationInstance `json:"items"`
}

// Repository type metadata.
var (
	MigrationInstance_Kind             = "MigrationInstance"
	MigrationInstance_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: MigrationInstance_Kind}.String()
	MigrationInstance_KindAPIVersion   = MigrationInstance_Kind + "." + CRDGroupVersion.String()
	MigrationInstance_GroupVersionKind = CRDGroupVersion.WithKind(MigrationInstance_Kind)
)

func init() {
	SchemeBuilder.Register(&MigrationInstance{}, &MigrationInstanceList{})
}
