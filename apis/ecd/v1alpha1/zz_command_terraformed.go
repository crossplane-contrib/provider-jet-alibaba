...
func (tr *Command) GetObservation() (map[string]interface{}, error) {
...
func (tr *Command) SetObservation(obs map[string]interface{}) error {
...
func (tr *Command) GetParameters() (map[string]interface{}, error) {
...
func (tr *Command) SetParameters(params map[string]interface{}) error {
