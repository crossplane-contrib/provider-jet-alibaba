...
func (tr *DiskAttachment) GetObservation() (map[string]interface{}, error) {
...
func (tr *DiskAttachment) SetObservation(obs map[string]interface{}) error {
...
func (tr *DiskAttachment) GetParameters() (map[string]interface{}, error) {
...
func (tr *DiskAttachment) SetParameters(params map[string]interface{}) error {
