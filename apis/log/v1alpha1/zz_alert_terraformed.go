...
func (tr *Alert) GetObservation() (map[string]interface{}, error) {
...
func (tr *Alert) SetObservation(obs map[string]interface{}) error {
...
func (tr *Alert) GetParameters() (map[string]interface{}, error) {
...
func (tr *Alert) SetParameters(params map[string]interface{}) error {
