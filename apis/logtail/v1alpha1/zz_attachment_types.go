...
type AttachmentParameters struct {
	...
	LogtailConfigName *string `json:"logtailConfigName" tf:"logtail_config_name,omitempty"`

	// +kubebuilder:validation:Required
	MachineGroupName *string `json:"machineGroupName" tf:"machine_group_name,omitempty"`
