...
type AccessGroupParameters struct {
	...
	AccessGroupName *string `json:"accessGroupName,omitempty" tf:"access_group_name,omitempty"`

	// +kubebuilder:validation:Optional
	AccessGroupType *string `json:"accessGroupType,omitempty" tf:"access_group_type,omitempty"`
