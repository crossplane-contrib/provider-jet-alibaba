...
func (mg *AutoSnapshotPolicy) GetTerraformResourceType() string {
	return "alicloud_nas_auto_snapshot_policy"
}
...
func (tr *AutoSnapshotPolicy) GetObservation() (map[string]interface{}, error) {
...
func (tr *AutoSnapshotPolicy) SetObservation(obs map[string]interface{}) error {
...
func (tr *AutoSnapshotPolicy) GetParameters() (map[string]interface{}, error) {
...
func (tr *AutoSnapshotPolicy) SetParameters(params map[string]interface{}) error {
