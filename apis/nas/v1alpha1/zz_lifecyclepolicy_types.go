...
type LifecyclePolicyParameters struct {
	...
	// +kubebuilder:validation:Required
	LifecyclePolicyName *string `json:"lifecyclePolicyName" tf:"lifecycle_policy_name,omitempty"`

	// +kubebuilder:validation:Required
	LifecycleRuleName *string `json:"lifecycleRuleName" tf:"lifecycle_rule_name,omitempty"`
