...
func (tr *ACL) GetObservation() (map[string]interface{}, error) {
...
func (tr *ACL) SetObservation(obs map[string]interface{}) error {
...
func (tr *ACL) GetParameters() (map[string]interface{}, error) {
...
func (tr *ACL) SetParameters(params map[string]interface{}) error {
