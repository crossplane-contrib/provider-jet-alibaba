...
func (tr *ACLEntries) GetObservation() (map[string]interface{}, error) {
...
func (tr *ACLEntries) SetObservation(obs map[string]interface{}) error {
...
func (tr *ACLEntries) GetParameters() (map[string]interface{}, error) {
...
func (tr *ACLEntries) SetParameters(params map[string]interface{}) error {
