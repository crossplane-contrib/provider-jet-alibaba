...
func (mg *ApplicationGroup) GetTerraformResourceType() string {
	return "alicloud_oos_application_group"
}
...
func (tr *ApplicationGroup) GetObservation() (map[string]interface{}, error) {
...
func (tr *ApplicationGroup) SetObservation(obs map[string]interface{}) error {
...
func (tr *ApplicationGroup) GetParameters() (map[string]interface{}, error) {
...
func (tr *ApplicationGroup) SetParameters(params map[string]interface{}) error {
