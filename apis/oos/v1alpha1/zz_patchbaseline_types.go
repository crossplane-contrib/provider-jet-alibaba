...
type PatchBaselineParameters struct {
	...
	ApprovalRules *string `json:"approvalRules" tf:"approval_rules,omitempty"`

	// +kubebuilder:validation:Optional
	Description *string `json:"description,omitempty" tf:"description,omitempty"`

	// +kubebuilder:validation:Required
	OperationSystem *string `json:"operationSystem" tf:"operation_system,omitempty"`

	// +kubebuilder:validation:Required
	PatchBaselineName *string `json:"patchBaselineName" tf:"patch_baseline_name,omitempty"`
}
