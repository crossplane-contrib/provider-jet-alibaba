...
func (mg *ServiceSetting) GetTerraformResourceType() string {
	return "alicloud_oos_service_setting"
}
...
func (tr *ServiceSetting) GetObservation() (map[string]interface{}, error) {
...
func (tr *ServiceSetting) SetObservation(obs map[string]interface{}) error {
...
func (tr *ServiceSetting) GetParameters() (map[string]interface{}, error) {
...
func (tr *ServiceSetting) SetParameters(params map[string]interface{}) error {
