...
type TableParameters struct {
	...
	DeviationCellVersionInSec *string `json:"deviationCellVersionInSec,omitempty" tf:"deviation_cell_version_in_sec,omitempty"`

	// +kubebuilder:validation:Required
	InstanceName *string `json:"instanceName" tf:"instance_name,omitempty"`

	// +kubebuilder:validation:Required
	MaxVersion *float64 `json:"maxVersion" tf:"max_version,omitempty"`

	// +kubebuilder:validation:Required
	PrimaryKey []PrimaryKeyParameters `json:"primaryKey" tf:"primary_key,omitempty"`

	// +kubebuilder:validation:Required
	TableName *string `json:"tableName" tf:"table_name,omitempty"`

	// +kubebuilder:validation:Required
	TimeToLive *float64 `json:"timeToLive" tf:"time_to_live,omitempty"`
}
