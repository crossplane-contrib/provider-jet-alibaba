...
func (mg *ZoneRecord) GetTerraformResourceType() string {
	return "alicloud_pvtz_zone_record"
}
...
func (tr *ZoneRecord) GetObservation() (map[string]interface{}, error) {
...
func (tr *ZoneRecord) SetObservation(obs map[string]interface{}) error {
...
func (tr *ZoneRecord) GetParameters() (map[string]interface{}, error) {
...
func (tr *ZoneRecord) SetParameters(params map[string]interface{}) error {
