...
type OrganizationParameters struct {
	...
	DesiredMemberCount *float64 `json:"desiredMemberCount,omitempty" tf:"desired_member_count,omitempty"`

	// +kubebuilder:validation:Required
	OrganizationName *string `json:"organizationName" tf:"organization_name,omitempty"`

	// +kubebuilder:validation:Optional
	RealPk *string `json:"realPk,omitempty" tf:"real_pk,omitempty"`
