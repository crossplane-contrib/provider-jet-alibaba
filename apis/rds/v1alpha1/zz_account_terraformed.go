...
func (mg *Account) GetTerraformResourceType() string {
	return "alicloud_rds_account"
}

// GetConnectionDetailsMapping for this Account
func (tr *Account) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"account_password": "spec.forProvider.accountPasswordSecretRef", "password": "spec.forProvider.passwordSecretRef"}
}
