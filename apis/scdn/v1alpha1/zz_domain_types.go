...
type CertInfosObservation struct {
}

type CertInfosParameters struct {
	...
	// +kubebuilder:validation:Optional
	SSLPriSecretRef *v1.SecretKeySelector `json:"sslPriSecretRef,omitempty" tf:"-"`
...
type DomainParameters struct {
	...
	// +kubebuilder:validation:Optional
	BizName *string `json:"bizName,omitempty" tf:"biz_name,omitempty"`

	// +kubebuilder:validation:Optional
	CertInfos []CertInfosParameters `json:"certInfos,omitempty" tf:"cert_infos,omitempty"`
