...
func (in *CertInfosObservation) DeepCopyInto(out *CertInfosObservation) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CertInfosObservation.
func (in *CertInfosObservation) DeepCopy() *CertInfosObservation {
	if in == nil {
		return nil
	}
	out := new(CertInfosObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CertInfosParameters) DeepCopyInto(out *CertInfosParameters) {
	*out = *in
	if in.CertName != nil {
	...
	if in.SSLPriSecretRef != nil {
		in, out := &in.SSLPriSecretRef, &out.SSLPriSecretRef
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CertInfosParameters.
func (in *CertInfosParameters) DeepCopy() *CertInfosParameters {
	if in == nil {
		return nil
	}
	out := new(CertInfosParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DomainParameters) DeepCopyInto(out *DomainParameters) {
	*out = *in
	...
	if in.CertInfos != nil {
		in, out := &in.CertInfos, &out.CertInfos
		*out = make([]CertInfosParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
