...
func (tr *GroupRule) GetObservation() (map[string]interface{}, error) {
...
func (tr *GroupRule) SetObservation(obs map[string]interface{}) error {
...
func (tr *GroupRule) GetParameters() (map[string]interface{}, error) {
...
func (tr *GroupRule) SetParameters(params map[string]interface{}) error {
