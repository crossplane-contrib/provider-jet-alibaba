...
func (mg *ServerGroup) GetTerraformResourceType() string {
	return "alicloud_slb_server_group"
}
...
func (tr *ServerGroup) GetObservation() (map[string]interface{}, error) {
...
func (tr *ServerGroup) SetObservation(obs map[string]interface{}) error {
...
func (tr *ServerGroup) GetParameters() (map[string]interface{}, error) {
...
func (tr *ServerGroup) SetParameters(params map[string]interface{}) error {
